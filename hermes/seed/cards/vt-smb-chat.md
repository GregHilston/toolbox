...
Four files in `data/raw/` (your shell already starts in the workspace):
...
Build a Python package here, following ENGINEERING.md: domain/ pure (no I/O imports), DTOs adapter-local and frozen, ports as typing.Protocol, one mapper per source tested against that source as a recorded fixture.
