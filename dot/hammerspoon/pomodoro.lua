...
-- from: https://github.com/af/dotfiles/blob/main/hammerspoon/pomodoro.lua
--
-- Notes:
...
local INTERVAL_SECONDS = 1     -- Set to 60 (one minute) for real use; set lower for debugging
