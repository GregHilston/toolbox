...
xrandr \
    --output DP-0 --primary --mode 1920x1080 --pos 0x0 --rotate left \
    --output DP-2 --primary --mode 2560x1440 --pos 1080x0 --rotate normal \
    --output DP-4 --primary --mode 1920x1080 --pos 3640x0 --rotate right
