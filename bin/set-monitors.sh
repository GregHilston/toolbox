...
xrandr \
    --output DP-0 --mode 1920x1080 --pos 0x0 --rotate left -r 144 \
    --output DP-2 --primary --mode 2560x1440 --pos 1080x0 --rotate normal -r 150 \
    --output DP-4 --mode 1920x1080 --pos 3640x0 --rotate right -r 144
